<template>
  <div id='container' class='cls-container'>
    ...
    <div class='cls-header cls-header-lg' style="background-color: orange">
      <div class='cls-brand'>
      </div>
    </div>
    <div class="panel">
      <div class="panel-body">
        <div class="col-lg-6" style="padding-left: 60px;padding-top: 30px;">
          <div>
            <h3 style="color:green">HỆ THỐNG CHUYỂN ĐỔI UID FACEBOOK SANG SĐT</h3>
            <!-- <span style="color:black;font-size: larger">(Ninja Auto Like Facebook)</span> -->
            <p>- Chuyển đổi UID Facebook sang SĐT</p>
            <p>- Chuyển đổi link Facebook URL sang UID Facebook</p>
            <p>- Nhận tập data UID Facebook từ Excel và text để chuyển đổi sang SDT</p>
          </div>
        </div>
        <div class='cls-content col-lg-6'>
          <div class='cls-content-sm panel'>
            <div class='panel-body' style="border-style: ridge;border-radius: 8px;">
              <p class='pad-btm'>Đăng nhập hệ thống convert FacebookUid sang SĐT</p>
                <div class='form-group'>
                  <div class='input-group'>
                    <div class='input-group-addon'><i class='fa fa-user'></i></div>
                    <input type='text' v-model='input.email' class='form-control' placeholder='Email của bạn'>
                  </div>
                </div>
                <div class='form-group'>
                  <div class='input-group'>
                    <div class='input-group-addon'><i class='fa fa-asterisk'></i></div>
                    <input type='password' v-model='input.password' class='form-control' placeholder='Mật khẩu'>
                  </div>
                </div>
                <div class='row'>
                  <div class='col-xs-12'>
                    <div class='form-group text-center'>
                      <button class='btn btn-success text-uppercase' v-on:click='sendData()'>Đăng Nhập</button>
                    </div>
                  </div>
                </div>
            </div>
      ...
      <div class="row">
          <div class="col-lg-12">
           <img width="100%" src="http://sayfb.com/banggiaconvertsdt.jpg"/>
           <!-- <img width="100%" src="/banggiaconvertsdt.jpg"/> -->
           </div>
        </div>
    </div>
  </div>
    ...
    sendData () {
      axios({
        ...
        if (result.data.status === true) {
          ...
          this.$session.set('email', result.data.email)
          this.$session.set('point', result.data.point)
